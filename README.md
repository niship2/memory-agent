...
3. Select a different model: We default to openai/gpt-4o. You can select a compatible chat model using provider/model-name via configuration. Example: openai/gpt-4.
